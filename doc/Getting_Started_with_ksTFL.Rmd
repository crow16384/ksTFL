...
**What happens**:
- File path is validated (must exist and be readable)
- Minimal metadata is created
- Figure will be copied to output directory when saved
...
| Create figure spec | `create_figure(data = "path.png")` | Path must be readable |
