...
source(file.path(getwd(),'inst','examples','showcase','structures','ae_tbl_01.R')) 

#############################################################
# Простая таблица НЯ
#############################################################

#  AESOC                       AEDECOD                XXX_1001L_rate_c XXX_1001H_rate_c XXX_1001A_rate_c PLA_rate_c XXX_1001L_rd              XXX_1001H_rd       XXX_1001A_rd
...
spec_ae_01 <- create_table(data, #параметр cols опциональный. При необходимости позволяет выбрать нужные колонки в нужном для репорта порядке.
                      ...
                      cols = c(AESOC, AEDECOD, XXX_1001L_rate_c, XXX_1001H_rate_c, XXX_1001A_rate_c, PLA_rate_c, XXX_1001L_rd, XXX_1001H_rd, XXX_1001A_rd)) %>% 
  ...
  add_footnote("Abbreviations: AE, adverse event; AESI, adverse event of special interest; CI, confidence interval; XXX_1001, Some_drug; N, number of patients in treatment arm; n, number of patients with at least one adverse event") %>% 
  add_footnote(c("Note: MedDRA version 25.1", "Note: XXX_1001 Low dose = Some_drug sc 64 mg q4w", "Note: XXX_1001 High dose = Some_drug sc 64 mg q2w")) %>% 
  ...
  define_cols(
    c(XXX_1001L_rate_c, XXX_1001H_rate_c, XXX_1001A_rate_c, PLA_rate_c),
    label = c("XXX_1001 Low Dose<br>(N=782)<br>n(%)", "XXX_1001 High Dose<br>(N=742)<br>n(%)", "XXX_1001 All Doses<br>(N=1524)<br>n(%)", "Placebo<br>(N=454)<br>n(%)"),
  ...
  define_cols(
    ...
    label = c("XXX_1001 Low Dose", "XXX_1001 High Dose","XXX_1001 All Doses"), #Нужно только понимать, что количество элементов вектора должно совпадать с количеством выбранных колонок!
    colWidth = "15%"
  ) %>% 
...
r_ae_01 <- create_report(spec_ae_01)
# выводим нашу таблицу в DOCX документ
write_doc(r_ae_01, "showcase_12_ae_table")
...
#XXX_1001L_rate_c | XXX_1001 Low Dose<br>(N=782)<br>n(%)       | string | %s     |         | 7.7%  |       |             
#XXX_1001H_rate_c | XXX_1001 High Dose<br>(N=742)<br>n(%)      | string | %s     |         | 7.7%  |       |             
#XXX_1001A_rate_c | XXX_1001 All Doses<br>(N=1524)<br>n(%)     | string | %s     |         | 7.7%  |       |             
#PLA_rate_c  | Placebo<br>(N=454)<br>n(%)            | string | %s     |         | 7.0%  |       |             
#XXX_1001L_rd     | XXX_1001 Low Dose                          | string | %s     |         | 14.0% |       |             
#XXX_1001H_rd     | XXX_1001 High Dose                         | string | %s     |         | 14.0% |       |             
#XXX_1001A_rd     | XXX_1001 All Doses                         | string | %s     |         | 14.0% |       |             
...
#XXX_1001L_rate_c | XXX_1001 Low Dose<br>(N=782)<br>n(%)       | string | %s     |         | 8%    |       |             
#XXX_1001H_rate_c | XXX_1001 High Dose<br>(N=742)<br>n(%)      | string | %s     |         | 8%    |       |             
#XXX_1001A_rate_c | XXX_1001 All Doses<br>(N=1524)<br>n(%)     | string | %s     |         | 8%    |       |             
#PLA_rate_c  | Placebo<br>(N=454)<br>n(%)            | string | %s     |         | 8%    |       |             
#XXX_1001L_rd     | XXX_1001 Low Dose                          | string | %s     |         | 15%   |       |             
#XXX_1001H_rd     | XXX_1001 High Dose                         | string | %s     |         | 15%   |       |             
#XXX_1001A_rd     | XXX_1001 All Doses                         | string | %s     |         | 15%   |       |               
