...
- Audience: users who already built at least one spec and now need to debug or
  sharpen a workflow
- Focus: small but important behaviors that are easy to miss on a first read
- Outcome: faster diagnosis and cleaner report programs

When a source program is mentioned below, it refers to the corresponding script
under `inst/examples/showcase/`.

Related reading:

- [Getting Started](Getting_Started_with_ksTFL.Rmd) for the core pipeline and
  object model
- [Reporting Examples](Reporting_Examples_with_ksTFL.Rmd) for minimal end-to-
  end patterns
- [Real Examples](Real_Examples_with_ksTFL.Rmd) for fuller clinical-style
  outputs
- [Advanced StyleRows](Advanced_StyleRows.Rmd) for `compute_cols()` and row
  actions
- [Column Width Management](Column_Width_Management.Rmd) for width locking and
  hidden-column rules
- [Font Management](Font_Management.Rmd) for font discovery and fallback
- [Rendering Pipeline](Rendering_Pipeline.Rmd) for renderer internals
...
See also: [Getting Started](Getting_Started_with_ksTFL.Rmd), [Reporting
Examples](Reporting_Examples_with_ksTFL.Rmd), `01_clinical_table_showcase.R`.
...
See also: [Real Examples](Real_Examples_with_ksTFL.Rmd), [Advanced
StyleRows](Advanced_StyleRows.Rmd), `01_clinical_table_showcase.R`,
`10_ae_template_ru_real_counts.R`.
...
See also: [Column Width Management](Column_Width_Management.Rmd), [Getting
Started](Getting_Started_with_ksTFL.Rmd).
...
See also: [Column Width Management](Column_Width_Management.Rmd),
...
See also: [Advanced StyleRows](Advanced_StyleRows.Rmd),
...
See also: [Advanced StyleRows](Advanced_StyleRows.Rmd), [Real
Examples](Real_Examples_with_ksTFL.Rmd).
...
See also: [Advanced StyleRows](Advanced_StyleRows.Rmd), [Getting
Started](Getting_Started_with_ksTFL.Rmd).
...
See also: [Getting Started](Getting_Started_with_ksTFL.Rmd), [Real
Examples](Real_Examples_with_ksTFL.Rmd), `12_ae_table.R`.
...
See also: [Real Examples](Real_Examples_with_ksTFL.Rmd), [Rendering
Pipeline](Rendering_Pipeline.Rmd), `02_listing_paging_colbreak.R`.
...
See also: [Getting Started](Getting_Started_with_ksTFL.Rmd),
