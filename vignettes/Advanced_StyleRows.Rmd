...
`compute_cols()` uses **lazy evaluation**—it captures your conditions
and actions as unevaluated expressions (quosures), storing them in the
spec's metadata. The actual evaluation happens later during
`create_report()`, when all specs are finalized and the data context is
fully established.
...
![](images/clipboard-3800596295.png)
...
![](images/clipboard-2820420209.png)
...
![](images/clipboard-3635852446.png)
...
![](images/clipboard-3833113929.png)
...
![](images/clipboard-1422833318.png){width="316"}
...
![](images/clipboard-4018027858.png)
...
![](images/clipboard-135355541.png)
...
![](images/clipboard-3199120875.png)
...
![](images/clipboard-1433567229.png)
...
![](images/clipboard-3785452628.png)
...
![](images/clipboard-155381044.png)
...
![](images/clipboard-442851926.png)
...
![](images/clipboard-277123039.png)
...
![](images/clipboard-3788815761.png)
...
![](images/clipboard-1457968813.png)
...
![](images/clipboard-994528206.png)

become a production ready table:\
![](images/clipboard-2616986225.png)
...
-   [Getting Started](Getting_Started_with_ksTFL.Rmd) — full pipeline
    overview and `compute_cols()` introduction
-   [Styling Guide](Styling_Guide_with_ksTFL.Rmd) — styling fundamentals
    and built-in atoms
-   [Reporting Examples](Reporting_Examples_with_ksTFL.Rmd) — complete
    end-to-end workflows
-   [Column Width Management](Column_Width_Management.Rmd) — invisible
