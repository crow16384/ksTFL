...
2. **Reference by name**: In `define_cols()`, `add_title()`, `add_stub_column()`, use `labelStyleRef` or `valueStyleRef` to point to styles by id
...
### 3. Spanning headers — `labelStyleRef` in `add_stub_column()`
...
spec <- add_stub_column(spec, cols = c("mpg", "cyl"), label = "Engine",
...
spec <- add_stub_column(spec, cols = c("var1", "var2", "var3"), label = "Baseline",
  stubOrder = 1, labelStyleRef = "level1_stub")

spec <- add_stub_column(spec, cols = c("var1", "var2"), label = "Safety",
