...
Examples](Reporting_Examples_with_ksTFL.Rmd). For a quick start see
[Getting Started](Getting_Started_with_ksTFL.Rmd).
...
**Note**: `s_borders()` is always used **inside `s_table_style()`**,
never standalone.
...
-   Function documentation: `?add_style`, `?s_font`, `?s_paragraph`,
    `?f_combine`
-   [Reporting Examples](Reporting_Examples_with_ksTFL.Rmd) — working
