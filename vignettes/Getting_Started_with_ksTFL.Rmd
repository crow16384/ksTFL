...
- **External renderer**: Consumes the specification and produces the final DOCX/PDF/HTML file
...
save_report() (validate, serialize, write JSON + data files)
       ↓
Metadata + Data Files → External Renderer → Final DOCX
```
...
# Helper functions (firstOf, lastOf, uniqueOf)
