...
1\. [Reporting Examples](Reporting_Examples_with_ksTFL.Rmd) for
realistic workflow patterns.

2\. [Styling Guide](Styling_Guide_with_ksTFL.Rmd) for style primitives
and reusable style systems.

3\. [Column Width Management](Column_Width_Management.Rmd) for layout
tuning.

4\. [Advanced StyleRows](Advanced_StyleRows.Rmd) for conditional row
actions.

5\. [Font Management](Font_Management.Rmd) for system font discovery,
custom font directories, and fallback behavior.

6\. [Rendering Pipeline](Rendering_Pipeline.Rmd) for detailed C++
architecture and DOCX emission internals.
