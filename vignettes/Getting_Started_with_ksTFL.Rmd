...
spec_fig <- create_figure("plots/figure1.png", docPrefix = "fig01")
...
| Set document properties | `set_document(spec, docPrefix = ..., hasData = ...)` | Optional: configure doc prefix, content width, placement |
