...
5. `Font_Management` for system font discovery, custom font directories, and fallback behavior.
6. `Rendering_Pipeline` for detailed C++ architecture and DOCX emission internals.
