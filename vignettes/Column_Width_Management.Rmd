...
ksTFL partitions table columns into three categories that determine how widths are calculated:
...
- Recalculation without re-parsing width strings
- Tracking which columns are locked vs. unlocked
- Preserving initial proportions for normalization
...
For more examples, see `vignette("Reporting_Examples_with_ksTFL")`.
