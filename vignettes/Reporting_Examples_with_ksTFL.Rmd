...
Notes: `save_report()` is the public entrypoint to persist specs/data/figures for downstream rendering. In a real workflow, the Python renderer consumes the `metaPath` directory.
