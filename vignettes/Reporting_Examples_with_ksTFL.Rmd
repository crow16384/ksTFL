...
> a `compute_cols()` condition to drive styling or value
> transformations. This design means you never need to pre-filter or
> reorder your data frame before passing it to ksTFL — `cols` handles
> column selection and ordering in one place.
