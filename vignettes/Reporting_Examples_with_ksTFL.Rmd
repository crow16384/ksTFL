...
spec_stub_simple <- add_stub_column(spec_stub_simple, 
                                    cols = c("age", "sex"), 
                                    label = "Demographics")
...
spec_stubs_multi <- add_stub_column(spec_stubs_multi,
...
spec_stubs_style <- add_stub_column(spec_stubs_style,
                                    cols = c("age", "sex"),
                                    label = "Demographics",
...
- Styles must be defined before referencing them in `add_stub_column()`
...
## 11 — Save report (end-to-end export)
...
## 12 — Session-wide `tfl_options`: common headers/footers and default body text
