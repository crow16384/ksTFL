...
public:
  ...
  void element_with_attr(const std::string &name, const std::string &attr_name, const std::string &attr_value);

  /// Convenience: write a self-closing element with one int attribute.
  void element_with_attr(const std::string &name, const std::string &attr_name, int64_t attr_value);
